...
var Insertion$1 = function Insertion(_ref5) {
  var cache = _ref5.cache, serialized = _ref5.serialized, isStringTag = _ref5.isStringTag;
  registerStyles(cache, serialized, isStringTag);
...
var Insertion2 = function Insertion3(_ref5) {
  var cache = _ref5.cache, serialized = _ref5.serialized, isStringTag = _ref5.isStringTag;
  registerStyles(cache, serialized, isStringTag);
  useInsertionEffectAlwaysWithSyncFallback(function() {
    return insertStyles(cache, serialized, isStringTag);
...
function Flex({
  ...
  return /* @__PURE__ */ jsx$1(Container$a, { className, ...props, children });
}
const Container$a = /* @__PURE__ */ createStyled("div", {
  target: "e1uqr3bk0"
})("width:100%;height:100%;display:flex;flex-direction:", ({
  flexDirection
}) => flexDirection ?? "column", ";justify-content:", ({
  justifyContent
...
function Header({
  ...
  return /* @__PURE__ */ jsxs(HeaderContainer, { children: [
    /* @__PURE__ */ jsx$1(Logo, { children: left }),
    /* @__PURE__ */ jsx$1(RightWrapper, { children: right })
  ] });
}
const HeaderContainer = /* @__PURE__ */ createStyled("header", {
  target: "emr54tu2"
})({
  name: "ctw7ci",
  styles: "width:100%;height:64px;display:flex;position:sticky;top:0;justify-content:space-between;align-items:center;padding:16px 24px;background-color:black;z-index:999"
});
const Logo = /* @__PURE__ */ createStyled("h1", {
  target: "emr54tu1"
})({
  name: "1kv8fdq",
  styles: "font-size:24px;font-weight:800;color:white"
});
const RightWrapper = /* @__PURE__ */ createStyled(Flex, {
  target: "emr54tu0"
})({
  name: "1d7gpsg",
  styles: "width:fit-content;gap:4px"
});
function MobileLayout({
  children
}) {
  return /* @__PURE__ */ jsx$1(Flex, { children: /* @__PURE__ */ jsx$1(Container$9, { children }) });
}
const Container$9 = /* @__PURE__ */ createStyled("div", {
  target: "e1s2z2zr0"
})({
  name: "1h9ieyc",
  styles: "width:440px;min-height:fit-content;max-height:100vh;border:1px solid grey"
});
const StyledModalContainer = /* @__PURE__ */ createStyled("div", {
  target: "e1fqfpca1"
})({
  name: "1rhilk0",
  styles: "box-sizing:border-box;width:100%;max-width:425px;height:50px;position:fixed;background-color:rgba(253, 169, 169);top:120px;z-index:9999;left:50%;transform:translateX(-50%);border-radius:4px;animation:fadeIn 0.3s ease-in-out;@keyframes fadeIn{0%{opacity:0;top:0;}100%{opacity:1;top:8%;}}@keyframes fadeOut{0%{opacity:1;top:8%;}100%{opacity:0;top:0;}}"
});
const StyledModalContent = /* @__PURE__ */ createStyled("div", {
  target: "e1fqfpca0"
})({
  name: "sr3qqa",
  styles: "display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;padding:10px;margin:0"
});
const Toast = ({
  message,
  ...props
}) => {
  return reactDomExports.createPortal(/* @__PURE__ */ jsx$1(StyledModalContainer, { "data-testid": "toast", children: /* @__PURE__ */ jsx$1(StyledModalContent, { role: "dialog", "aria-modal": "true", ...props, children: message }) }), document.body);
};
...
const ToastProvider = ({
  ...
  return /* @__PURE__ */ jsxs(ToastContext.Provider, { value: {
    showToast
  }, children: [
    children,
...
function APIDataProvider({
  ...
  return /* @__PURE__ */ jsx$1(APIContext.Provider, { value: {
    state,
    setState
  }, children });
}
function useAPIDataContext({
  fetcher,
  name
}) {
  const {
    state,
    setState
  } = reactExports.useContext(APIContext);
  const {
    showToast
  } = reactExports.useContext(ToastContext);
...
const reset = {
  name: "17rrm05",
  styles: '@import url("https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/dist/web/static/pretendard-dynamic-subset.min.css");{}html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline;}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block;}body{line-height:1;}ol,ul{list-style:none;}blockquote,q{quotes:none;}blockquote:before,blockquote:after,q:before,q:after{content:"";content:none;}table{border-collapse:collapse;border-spacing:0;}*{box-sizing:border-box;}button{border:none;cursor:pointer;background-color:transparent;padding:0;margin:0;stroke:none;:focus{outline:none;stroke:none;}:hover{outline:none;stroke:none;}}p,span,a,div{font-family:-apple-system,BlinkMacSystemFont,"Apple SD Gothic Neo","Pretendard Variable",Pretendard,Roboto,"Noto Sans KR","Segoe UI","Malgun Gothic","Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol",sans-serif;}'
};
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx$1("h1", { children: "Something went wrong." }),
        /* @__PURE__ */ jsx$1("p", { children: "죄송합니다. 문제가 발생했습니다. 잠시 후 다시 시도해 주세요." })
      ] });
    }
...
async function baseAPI({
  ...
  const result = await fetch(`${baseURL}${path}`, {
    method,
    headers: {
      Authorization: `Basic ${btoa(`${"jeongyou"}:${"password"}`)}`,
...
function calculateTotalCartItemPrice(items) {
  return items.reduce((total, item) => total + item.product.price * item.quantity, 0);
}
const FREE_SHIPPING_THRESHOLD$1 = 1e5;
const SHIPPING_FEE = 3e3;
function calculateShippingFee(totalPrice) {
  if (totalPrice === 0 || totalPrice >= FREE_SHIPPING_THRESHOLD$1) {
    return 0;
  }
  return SHIPPING_FEE;
}
const OrderListContext = reactExports.createContext({
  selectionMap: {},
  setSelectionMap: () => {
  },
  cartListData: [],
...
const OrderListProvider = ({
  ...
  return /* @__PURE__ */ jsx$1(OrderListContext.Provider, { value: {
    selectionMap,
    setSelectionMap,
    cartListData,
    cartRefetch,
...
const useOrderListContext = () => {
  const context = reactExports.useContext(OrderListContext);
  if (!context) {
    throw new Error("useOrderListContext must be used within an OrderListProvider");
  }
  const {
    selectionMap,
    setSelectionMap,
  ...
  reactExports.useEffect(() => {
    if (!cartListData)
      return;
    setSelectionMap((prev2) => {
      const nextMap = {};
      for (const cart of cartListData) {
        nextMap[cart.id] = prev2[cart.id] ?? true;
      }
      return nextMap;
    });
...
const OrderConfirmPage = () => {
  ...
  const payment = (_a = location.state) == null ? void 0 : _a.payment;
  ...
  const totalCount = selectedItems.reduce((acc, cart) => acc + cart.quantity, 0);
  return /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
    /* @__PURE__ */ jsx$1(Header, {}),
    /* @__PURE__ */ jsx$1(Container$8, { children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "center", alignItems: "center", gap: "lg", children: [
      /* @__PURE__ */ jsx$1(InfoTitle$1, { children: "결제 확인" }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs(Description$1, { "aria-label": `총 ${typeCount}종류의 상품 ${totalCount}개를 주문했습니다.`, children: [
          "총 ",
          typeCount,
          "종류의 상품 ",
          totalCount,
        ...
        /* @__PURE__ */ jsx$1(Description$1, { children: "최종 결제 금액을 확인해 확인해 주세요." })
      ] }),
      /* @__PURE__ */ jsx$1(Subtitle, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxs(InfoTitle$1, { "aria-label": `총 결제 금액은 ${payment.toLocaleString()}원 입니다.`, children: [
...
const Container$8 = /* @__PURE__ */ createStyled(Flex, {
  ...
  name: "1aodlhv",
  styles: "padding:0 24px;height:calc(100vh - 116px)"
});
const InfoTitle$1 = /* @__PURE__ */ createStyled("h2", {
  target: "elupori3"
})({
  name: "1m6tkc",
  styles: "font-size:24px;font-weight:bold"
});
const Subtitle = /* @__PURE__ */ createStyled("h2", {
  target: "elupori2"
})({
  name: "6x2f5o",
  styles: "font-size:16px;font-weight:bold"
});
const Description$1 = /* @__PURE__ */ createStyled("p", {
  target: "elupori1"
})({
  name: "rnnx2x",
  styles: "font-size:12px"
});
const GoToShoppingCart = /* @__PURE__ */ createStyled("button", {
  target: "elupori0"
})("position:sticky;bottom:0;width:100%;padding:16px;background-color:", ({
  $isDisabled
}) => $isDisabled ? "#BDBDBD" : "#333", ";color:white;cursor:", ({
  $isDisabled
}) => $isDisabled ? "not-allowed" : "pointer", ";border-radius:0px;");
const CheckBox = ({
  isChecked,
  onToggle,
  ...props
}) => {
  return /* @__PURE__ */ jsx$1(CheckButton, { isChecked, onClick: onToggle, ...props, children: /* @__PURE__ */ jsx$1("svg", { width: "12", height: "10", viewBox: "0 0 18 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx$1("path", { d: "M5.88428 11.17L1.71428 7L0.294281 8.41L5.88428 14L17.8843 2L16.4743 0.589996L5.88428 11.17Z", fill: isChecked ? "#ffffff" : "#BDBDBD" }) }) });
};
const CheckButton = /* @__PURE__ */ createStyled("button", {
  target: "e10zxghz0"
})("width:22px;height:22px;display:flex;align-items:center;justify-content:center;background-color:", ({
  isChecked
}) => isChecked ? "black" : "white", ";border:", ({
  isChecked
}) => isChecked ? "black solid 1px" : "#BDBDBD solid 1px", ";border-radius:6px;cursor:pointer;");
function Counter({
  canBeZero = false,
  count,
  maxCount = -1,
  ...
  return /* @__PURE__ */ jsxs(QuantityControls, { ...props, children: [
    /* @__PURE__ */ jsx$1(QuantityButton, { onClick: onMinusClick, disabled: !canBeZero && count <= 1, "aria-label": showTrash ? "삭제" : "수량 감소", autoFocus, children: showTrash ? /* @__PURE__ */ jsx$1(TrashIcon, { src: `${"/react-shopping-cart/"}assets/icons/Trash.svg` }) : "−" }),
    /* @__PURE__ */ jsx$1(QuantityDisplay, { "aria-label": "수량", children: count }),
    /* @__PURE__ */ jsx$1(QuantityButton, { onClick: onPlusClick, "aria-label": "수량 증가", disabled: isMaxCountReached, children: "+" })
  ] });
}
const TrashIcon = /* @__PURE__ */ createStyled("img", {
  target: "e1ssyhmd3"
})({
  name: "157xhr7",
  styles: "width:16px;height:16px"
});
const QuantityControls = /* @__PURE__ */ createStyled("div", {
  target: "e1ssyhmd2"
})({
  name: "1qiievh",
  styles: "display:flex;align-items:center;gap:12px;margin-top:8px"
});
const QuantityButton = /* @__PURE__ */ createStyled("button", {
  target: "e1ssyhmd1"
})({
  name: "1rwnq50",
  styles: "width:32px;height:32px;border-radius:8px;border:1px solid #e0e0e0;background-color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:16px;color:#666;&:hover{background-color:#f5f5f5;}&:disabled{opacity:0.5;cursor:not-allowed;}"
});
const QuantityDisplay = /* @__PURE__ */ createStyled("span", {
  target: "e1ssyhmd0"
})({
  name: "1y1mmt5",
  styles: "font-size:16px;font-weight:500;min-width:20px;text-align:center;color:#000"
});
function Image({
  imageSource,
  altText = "이미지",
  ...
  const [imageUrl, setImageUrl] = reactExports.useState(imageSource);
  return /* @__PURE__ */ jsx$1(ImageContainer, { src: imageUrl, alt: altText, isSoldout: isSoldOut, onError: () => {
    setImageUrl("./assets/images/DefaultImage.jpg");
  }, ...props });
}
const ImageContainer = /* @__PURE__ */ createStyled("img", {
  target: "elj7lku0"
})("width:", ({
  width
}) => width || "100%", ";height:", ({
  ...
  isSoldout
}) => isSoldout && `filter: grayscale(100%) brightness(0.5);`, " ", ({
  position: position2
...
function CartCheckList() {
  ...
  const isSelectAll = !Object.values(selectionMap).some((isSelected) => !isSelected);
  ...
  const handleToggleSelection = (cartId) => {
    setSelectionMap((prev2) => ({
      ...prev2,
      [cartId]: !prev2[cartId]
    }));
  ...
  const getCartItemById = (cartId) => {
    const cart = cartListData == null ? void 0 : cartListData.find((cart2) => cart2.id === cartId);
    if (!cart)
      throw new Error("장바구니에 해당 아이템이 없습니다.");
    return cart;
  };
  ...
  const handleMinusQuantity = async (cartId) => {
    try {
      if (!cartListData)
        return;
      const cart = getCartItemById(cartId);
  ...
  if (!cartListData) {
    return /* @__PURE__ */ jsx$1(LoadingCartItem$1, { children: "장바구니를 불러오는 중..." });
  }
  const removeItem = async (id2) => {
    try {
  ...
  return /* @__PURE__ */ jsxs(Container$7, { children: [
    /* @__PURE__ */ jsxs(CheckedAll, { children: [
      /* @__PURE__ */ jsx$1(CheckBox, { isChecked: isSelectAll, onToggle: () => handleSelectAll(), "aria-label": "전체 선택 체크박스", "aria-checked": isSelectAll }),
      /* @__PURE__ */ jsx$1("p", { children: "전체 선택" })
    ] }),
    /* @__PURE__ */ jsx$1(ItemList$1, { children: isCartEmpty ? /* @__PURE__ */ jsxs(EmptyCartBox$1, { children: [
      /* @__PURE__ */ jsx$1(EmptyCartImage$1, { src: `${"/react-shopping-cart/"}assets/DeleteCart.svg` }),
      /* @__PURE__ */ jsx$1(EmptyCartText$1, { children: "장바구니에 담긴 상품이 없습니다." })
    ] }) : cartListData == null ? void 0 : cartListData.map((cart) => /* @__PURE__ */ jsxs(ItemWithCheckboxContainer$1, { children: [
      /* @__PURE__ */ jsx$1(CheckBox, { isChecked: selectionMap[cart.id], onToggle: () => handleToggleSelection(cart.id), "aria-label": "상품 선택 체크박스", "aria-checked": selectionMap[cart.id] }),
      /* @__PURE__ */ jsxs(ItemContainer$1, { children: [
        /* @__PURE__ */ jsx$1(Image, { width: "80px", height: "80px", imageSource: cart.product.imageUrl, altText: `${cart.product.name} 상품 이미지` }),
        /* @__PURE__ */ jsxs(ProductInfo$1, { "aria-label": "상품 정보", children: [
          /* @__PURE__ */ jsx$1(ProductName$1, { children: cart.product.name }),
          /* @__PURE__ */ jsx$1(ProductPrice$1, { children: formatPrice(cart.product.price) }),
          /* @__PURE__ */ jsx$1(Counter, { canBeZero: false, count: cart.quantity, maxCount: cart.product.quantity, onPlusClick: () => handlePlusQuantity(cart.id), onMinusClick: () => handleMinusQuantity(cart.id) })
        ] }),
        /* @__PURE__ */ jsx$1(DeleteButton, { onClick: () => removeItem(cart.id), children: "삭제" })
      ] })
    ] }, cart.id)) })
  ] });
}
const Container$7 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr12"
})({
  name: "19g7nlu",
  styles: "width:100%;max-width:480px"
});
const LoadingCartItem$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr11"
})({
  name: "bflawv",
  styles: "width:100%;height:380px;display:flex;justify-content:center;align-items:center"
});
const ItemList$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr10"
})({
  name: "q6e51o",
  styles: "height:380px;display:flex;flex-direction:column;gap:16px;padding-top:16px;margin-bottom:32px;overflow-y:auto"
});
const CheckedAll = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr9"
})({
  name: "r3005k",
  styles: "width:100%;display:flex;gap:8px;align-items:center;padding:16px 0;border-bottom:1px solid #bdbdbd"
});
const ItemWithCheckboxContainer$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr8"
})({
  name: "sp7e3y",
  styles: "display:flex;flex-direction:column;&:last-child{border-bottom:none;}"
});
const ItemContainer$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr7"
})({
  name: "14ootmy",
  styles: "display:flex;gap:16px;padding:16px 0;border-bottom:1px solid #f0f0f0;align-items:flex-start"
});
const ProductInfo$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr6"
})({
  name: "1cywlxn",
  styles: "flex:1;display:flex;flex-direction:column;gap:8px;align-items:flex-start"
});
const ProductName$1 = /* @__PURE__ */ createStyled("p", {
  target: "e1tlp3yr5"
})({
  name: "1flj9lk",
  styles: "text-align:left"
});
const ProductPrice$1 = /* @__PURE__ */ createStyled("p", {
  target: "e1tlp3yr4"
})("");
const DeleteButton = /* @__PURE__ */ createStyled("button", {
  target: "e1tlp3yr3"
})({
  name: "8bu0wz",
  styles: "padding:8px 16px;border:1px solid #e0e0e0;border-radius:6px;background-color:#fff;color:#666;cursor:pointer;&:hover{background-color:#f5f5f5;}"
});
const EmptyCartBox$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1tlp3yr2"
})({
  name: "w95t23",
  styles: "display:flex;flex-direction:column;justify-content:center;align-items:center;gap:16px;text-align:center;padding:32px"
});
const EmptyCartImage$1 = /* @__PURE__ */ createStyled("img", {
  target: "e1tlp3yr1"
})({
  name: "1t6d9e9",
  styles: "width:80px;height:80px;object-fit:cover;opacity:0.3"
});
const EmptyCartText$1 = /* @__PURE__ */ createStyled("p", {
  target: "e1tlp3yr0"
})({
  name: "1ldzpx6",
  styles: "width:100%;color:grey"
});
const CartTitle = () => {
  const {
    cartListData
  } = useOrderListContext();
  return /* @__PURE__ */ jsxs(Flex, { gap: "sm", alignItems: "flex-start", children: [
    /* @__PURE__ */ jsx$1(Title$1, { children: "장바구니" }),
    /* @__PURE__ */ jsx$1(CartCountInfoText, { children: cartListData && cartListData.length !== 0 && `현재 ${cartListData.length}종류의 상품이 담겨있습니다.` })
  ] });
};
const Title$1 = /* @__PURE__ */ createStyled("h1", {
  target: "e1lmaiqo1"
})({
  name: "1m6tkc",
  styles: "font-size:24px;font-weight:bold"
});
const CartCountInfoText = /* @__PURE__ */ createStyled("p", {
  target: "e1lmaiqo0"
})({
  name: "mmdt3g",
...
const LabelPrice = ({
  ...
  return /* @__PURE__ */ jsxs(TotalSection, { children: [
    /* @__PURE__ */ jsx$1(TotalLabel, { children: label }),
    /* @__PURE__ */ jsxs(TotalAmount, { "aria-label": label, children: [
      price.toLocaleString(),
      "원"
    ] })
  ] });
};
const TotalSection = /* @__PURE__ */ createStyled(Flex, {
  target: "e1mkbt1q2"
})({
  name: "1fmj0pa",
  styles: "flex-direction:row;justify-content:space-between"
});
const TotalLabel = /* @__PURE__ */ createStyled("span", {
  target: "e1mkbt1q1"
})({
  name: "12gqizi",
  styles: "font-size:16px;font-weight:700"
});
const TotalAmount = /* @__PURE__ */ createStyled("span", {
  target: "e1mkbt1q0"
})({
  name: "i0m1bj",
...
const LabelPriceContainer = () => {
  ...
  return /* @__PURE__ */ jsxs(Container$6, { children: [
    /* @__PURE__ */ jsxs(InfoBox, { children: [
      /* @__PURE__ */ jsx$1(InfoIcon, { src: `${"/react-shopping-cart/"}assets/icons/Info.svg`, alt: "info 아이콘" }),
      /* @__PURE__ */ jsx$1(InfoMessage, { children: "총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." })
    ] }),
    /* @__PURE__ */ jsxs(PriceWrapper$1, { children: [
      /* @__PURE__ */ jsx$1(LabelPrice, { label: "주문 금액", price: orderPrice }),
      /* @__PURE__ */ jsx$1(LabelPrice, { label: "배송비", price: shippingFee })
    ] }),
    /* @__PURE__ */ jsx$1(LabelPrice, { label: "총 결제 금액", price: totalPrice })
  ] });
};
const InfoBox = /* @__PURE__ */ createStyled("div", {
  target: "euc74mu4"
})({
  name: "axgjri",
  styles: "width:100%;display:flex;justify-content:flex-start;gap:4px"
});
const InfoMessage = /* @__PURE__ */ createStyled("p", {
  target: "euc74mu3"
})({
  name: "1mg1x5f",
  styles: "font-size:12px;font-weight:500"
});
const InfoIcon = /* @__PURE__ */ createStyled("img", {
  target: "euc74mu2"
})({
  name: "1djxupe",
  styles: "width:14px;height:14px"
});
const Container$6 = /* @__PURE__ */ createStyled(Flex, {
  target: "euc74mu1"
})({
  name: "1vbp2ia",
  styles: "flex-direction:column;gap:20px;height:180px"
});
const PriceWrapper$1 = /* @__PURE__ */ createStyled(Flex, {
  target: "euc74mu0"
})({
  name: "nhmwz0",
  styles: "border-top:1px solid grey;border-bottom:1px solid grey;padding:16px 0;gap:16px"
});
const CartLayout = () => {
  const {
    cartListData
  ...
  return /* @__PURE__ */ jsxs(Container$5, { children: [
    ...
    cartListData && cartListData.length === 0 ? /* @__PURE__ */ jsx$1(NoCartItem, { children: "장바구니에 아이템이 없습니다." }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx$1(CartCheckList, {}),
      /* @__PURE__ */ jsx$1(LabelPriceContainer, {})
    ] })
  ] });
};
const Container$5 = /* @__PURE__ */ createStyled(Flex, {
  target: "ekmaw761"
})({
  name: "yfmma8",
  styles: "padding:36px 24px"
});
const NoCartItem = /* @__PURE__ */ createStyled("div", {
  target: "ekmaw760"
})({
  name: "1orz7ls",
  styles: "width:100%;height:600px;display:flex;justify-content:center;align-items:center"
});
const ShoppingCartPage = () => {
  const {
    selectionMap
  } = useOrderListContext();
  const isDisabled = !Object.values(selectionMap).some((isSelected) => isSelected);
  const navigate = useNavigate();
  ...
  return /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
    /* @__PURE__ */ jsx$1(Header, { left: "SHOP" }),
    /* @__PURE__ */ jsx$1(CartLayout, {}),
    /* @__PURE__ */ jsx$1(CheckoutButton$1, { $isDisabled: isDisabled, disabled: isDisabled, onClick: handleCheckout, "aria-label": "주문 확인", children: "주문 확인" })
  ] });
};
const CheckoutButton$1 = /* @__PURE__ */ createStyled("button", {
  target: "e136c9j40"
})("width:100%;padding:16px;background-color:", ({
  $isDisabled
}) => $isDisabled ? "#BDBDBD" : "#333", ";color:white;cursor:", ({
  $isDisabled
}) => $isDisabled ? "not-allowed" : "pointer", ";border-radius:0px;");
...
const BackArrowButton = ({
  ...
  return /* @__PURE__ */ jsx$1("button", { onClick, ...props, children: /* @__PURE__ */ jsx$1("img", { src: `${"/react-shopping-cart/"}assets/icons/BackArrow.svg` }) });
};
const useModal = () => {
  const [showCouponModal, setShowCouponModal] = reactExports.useState(false);
  const handleShowCouponModal = () => {
    setShowCouponModal((prev2) => !prev2);
  };
  return {
    showCouponModal,
...
const useNavigation = (isDisabled, payment) => {
  const navigate = useNavigate();
...
const useApiRequest = () => {
  ...
  const handleRequest = reactExports.useCallback(async ({
    request,
    onSuccess,
    onError,
    options
...
const useCoupon = () => {
  const [coupons, setCoupons] = reactExports.useState(null);
  const {
    isLoading,
    handleRequest
  } = useApiRequest();
...
const getAllCouponCombinationIds = (availableCoupons) => {
  const result = [];
...
const couponValidator = (coupons, isJejuOrRemoteArea, orderItemList, orderPrice) => {
  ...
  coupons.forEach((coupon) => {
    ...
    if (coupon.code === COUPON_TYPE.FREESHIPPING) {
      if (isJejuOrRemoteArea) {
        ...
        if (orderPrice >= 5e4 && orderPrice < 1e5) {
          availableCoupons.push(coupon);
        }
      }
    }
...
const useAvailableCoupons = (coupons, isJejuOrRemoteArea) => {
  const {
    selectedItems,
    orderPrice
  } = useOrderListContext();
  const availableCoupons = reactExports.useMemo(() => {
    return couponValidator(coupons, isJejuOrRemoteArea, selectedItems, orderPrice);
  }, [coupons, isJejuOrRemoteArea, selectedItems, orderPrice]);
  return {
    availableCoupons
  };
};
const getMostExpensiveItem = (items) => items.reduce((prev2, curr) => prev2.product.price > curr.product.price ? prev2 : curr);
const getBogoEligibleItems = (orderList) => orderList.filter((item) => item.quantity >= 3);
const calculateBogoDiscount = (selectedItems) => {
...
const FIXED5000_DISCOUNT_THRESHOLD = 1e5;
const FIXED5000_DISCOUNT_AMOUNT = 5e3;
const calculateFixed5000Discount = (orderPrice) => {
...
const COUPON_MINIMUM_AMOUNT = 5e4;
const NORMAL_SHIPPING_FEE = 3e3;
const ISLAND_EXTRA_FEE = 3e3;
const calculateFreeShippingDiscount = (orderPrice, isJejuOrRemoteArea) => {
  if (orderPrice >= FREE_SHIPPING_THRESHOLD) {
    return isJejuOrRemoteArea ? ISLAND_EXTRA_FEE : 0;
  }
  if (orderPrice >= COUPON_MINIMUM_AMOUNT) {
    return isJejuOrRemoteArea ? NORMAL_SHIPPING_FEE + ISLAND_EXTRA_FEE : NORMAL_SHIPPING_FEE;
  }
  return 0;
};
const MIRACLE_SALE_DISCOUNT_RATE = 0.3;
const calculateMiracleSaleDiscount = (orderPrice) => {
  return orderPrice * MIRACLE_SALE_DISCOUNT_RATE;
};
const couponDiscountCalculators = {
...
const getDiscountByCouponId = (coupon, orderPrice, bogoItems, isJejuOrRemoteArea) => {
  const calculator = couponDiscountCalculators[coupon.code];
  if (!calculator)
    return 0;
  switch (coupon.code) {
    case "FIXED5000":
    case "MIRACLESALE":
      return calculator(orderPrice) ?? 0;
    case "FREESHIPPING":
      if (isJejuOrRemoteArea === void 0)
        return 0;
      return calculator(orderPrice, isJejuOrRemoteArea) ?? 0;
    case "BOGO":
      if (!bogoItems)
        return 0;
      return calculator(bogoItems) ?? 0;
    default:
      return 0;
  }
};
const useBestCouponCombination = (availableCoupons, allCouponCombinationIds, isJejuOrRemoteArea) => {
  const {
    selectedItems,
    orderPrice
  } = useOrderListContext();
  const combinations = allCouponCombinationIds.map((couponIds) => {
    const selectedCoupons = couponIds.map((id2) => availableCoupons.find((c2) => c2.id === id2)).filter(Boolean);
    let totalDiscount = 0;
    for (const coupon of selectedCoupons) {
      totalDiscount += getDiscountByCouponId(coupon, orderPrice, selectedItems, isJejuOrRemoteArea);
    }
    return {
      couponIds,
  ...
  const bestCombination = reactExports.useMemo(() => {
    return combinations.length > 0 ? combinations.reduce((prev2, curr) => curr.discount > prev2.discount ? curr : prev2) : {
      couponIds: [],
      discount: 0
    };
  }, [combinations]);
...
const useOrderCoupons = (isJejuOrRemoteArea) => {
  const {
    coupons,
    isLoading
  } = useCoupon();
  const {
    availableCoupons
  } = useAvailableCoupons(coupons ?? [], isJejuOrRemoteArea);
  const [allCouponCombinationIds, setAllCouponCombinationIds] = reactExports.useState([]);
  const isManual = reactExports.useRef(false);
  const {
    bestCouponIds,
    totalDiscount
  } = useBestCouponCombination(availableCoupons, allCouponCombinationIds, isJejuOrRemoteArea);
  const [selectedCouponIds, setSelectedCouponIds] = reactExports.useState(bestCouponIds);
  reactExports.useEffect(() => {
    setAllCouponCombinationIds(getAllCouponCombinationIds(availableCoupons));
  }, [availableCoupons]);
  const handleUpdateCouponCombinations = (coupons2) => {
    const combinations = getAllCouponCombinationIds(coupons2);
    setAllCouponCombinationIds(combinations);
  };
  const handleSelectCoupons = (newCoupons) => {
    isManual.current = true;
    setSelectedCouponIds(newCoupons);
    if (coupons) {
      const selectedCouponObjects = coupons.filter((coupon) => newCoupons.includes(coupon.id));
...
const useOrderInfo = () => {
  ...
  const orderList = (cartListData ?? []).filter((cart) => selectionMap[cart.id] === true);
...
const useShipping = () => {
  const [isJejuOrRemoteArea, setIsJejuOrRemoteArea] = reactExports.useState(false);
  const {
    shippingFee
  } = useOrderListContext();
  const calculateActualShippingFee = () => {
    if (isJejuOrRemoteArea) {
      return shippingFee + 3e3;
    }
    return shippingFee;
  };
  const actualShippingFee = calculateActualShippingFee();
  const handleJejuOrRemoteAreaToggle = () => {
    setIsJejuOrRemoteArea((prev2) => !prev2);
  };
  return {
    isJejuOrRemoteArea,
    actualShippingFee,
...
const InfoNotice = ({
  ...
  return /* @__PURE__ */ jsxs(Container$4, { children: [
    /* @__PURE__ */ jsx$1(Icon, { src: iconSrc, alt: altText }),
    /* @__PURE__ */ jsx$1(Message$1, { children })
  ] });
};
const Container$4 = /* @__PURE__ */ createStyled("div", {
  target: "egkendu2"
})({
  name: "axgjri",
  styles: "width:100%;display:flex;justify-content:flex-start;gap:4px"
});
const Icon = /* @__PURE__ */ createStyled("img", {
  target: "egkendu1"
})({
  name: "1djxupe",
  styles: "width:14px;height:14px"
});
const Message$1 = /* @__PURE__ */ createStyled("p", {
  target: "egkendu0"
})({
  name: "1mg1x5f",
  styles: "font-size:12px;font-weight:500"
...
const getFocusableElements = (container) => {
  return Array.from(container.querySelectorAll(FOCUSABLE_SELECTORS.join(","))).filter((el2) => !el2.hasAttribute("disabled"));
};
...
const ModalWrapperStyle = (show) => /* @__PURE__ */ css("position:fixed;width:100%;height:100vh;top:0;left:0;min-width:320px;display:", show ? "block" : "none", ";", "");
const backGroundStyle = (background) => /* @__PURE__ */ css("width:100%;height:100vh;position:absolute;top:0;left:0;background-color:rgba(0, 0, 0, 0.35);visibility:", background ? "visible" : "hidden", ";", "");
var _ref4 = {
  name: "1o592g",
  styles: "max-width:425px;margin:0 auto;width:100%"
};
const ModalContainerStyle = (position2) => {
  const positionStyle = getPositionStyle(position2);
  return /* @__PURE__ */ css("display:flex;flex-direction:column;background:#fff;z-index:99;box-sizing:border-box;padding:24px 32px;min-width:320px;", ["center", "bottom", "top"].includes(position2) && _ref4, " gap:16px;", positionStyle, ";", "");
};
const ModalHeaderStyle = {
  name: "th5gfg",
  styles: "display:flex;justify-content:space-between;align-items:center;width:100%;padding-bottom:12px;border-bottom:1px solid #ddd;img{cursor:pointer;}"
};
const ModalTitleStyle = (color) => /* @__PURE__ */ css("color:", color, ";font-size:18px;font-style:normal;font-weight:700;line-height:normal;", "");
const ModalBodyStyle = (height) => /* @__PURE__ */ css("display:flex;flex-direction:column;gap:18px;width:100%;height:", height, "px;max-height:614px;overflow-y:auto;", "");
const ModalFooterStyle = (align = "right") => /* @__PURE__ */ css("display:flex;flex-direction:column;justify-content:", align === "left" ? "flex-start" : align === "center" ? "center" : "flex-end", ";gap:10px;", "");
const ModalCloseStyle = {
  name: "1evihrl",
  styles: "background-color:transparent;border:0;cursor:pointer"
};
var _ref = {
  name: "5ilij8",
  styles: "border-radius:0 0 8px 8px;position:fixed;top:0;left:50%;transform:translateX(-50%)"
};
var _ref2 = {
  name: "1f8ph7e",
  styles: "border-radius:8px 8px 0 0;position:fixed;bottom:0;left:50%;transform:translateX(-50%)"
};
var _ref3 = {
  name: "1sgm90",
  styles: "width:calc(100% - 72px);border-radius:8px;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%)"
};
...
const baseButtonStyle = {
  name: "yec8sg",
  styles: "border:none;background:transparent;padding:0;margin:0;font:inherit;color:inherit;cursor:pointer"
};
const ConfirmButtonStyle = (disabled) => /* @__PURE__ */ css("border:0;background-color:", disabled ? "#ccc" : "#333333", ";color:", disabled ? "#666" : "#ffffff", ";padding-left:18px;padding-right:18px;height:36px;border-radius:5px;cursor:", disabled ? "not-allowed" : "pointer", ";", "");
const CancelButtonStyle = (variation = "secondary", widthSize) => {
  const base = /* @__PURE__ */ css("border:1px solid #ccc;padding-left:18px;padding-right:18px;height:36px;border-radius:5px;cursor:pointer;width:", widthSize, ";", "");
  if (variation === "primary") {
    return /* @__PURE__ */ css(base, ";background-color:black;color:white;border:none;&:hover{background-color:#222;}", "");
  }
  return /* @__PURE__ */ css(base, ";background-color:white;color:#333;border:1px solid #ccc;&:hover{background-color:#f5f5f5;}", "");
};
...
const BaseButton = ({
  ...
  return /* @__PURE__ */ jsx$1(StyledButton, { ...rest, disabled, children });
};
const CancelButton = ({
  children = "취소",
  variation = "primary",
...
const Modal = ({
  ...
  return /* @__PURE__ */ jsx$1(ModalContext.Provider, { value: {
    onHide
  }, children: /* @__PURE__ */ jsxs("div", { css: ModalWrapperStyle(show), children: [
    /* @__PURE__ */ jsx$1("div", { css: backGroundStyle(showBackdrop), onClick: onHide }),
    /* @__PURE__ */ jsx$1("div", { ref: containerRef, css: ModalContainerStyle(position2), role: "dialog", "aria-modal": "true", "aria-labelledby": "modal-title", children })
  ] }) });
};
const ModalHeader = ({
  closeButton = false,
  ...
  return /* @__PURE__ */ jsxs("div", { css: ModalHeaderStyle, children: [
    ...
    closeButton && /* @__PURE__ */ jsx$1("button", { css: ModalCloseStyle, onClick: onHide, "aria-label": "닫기", children: /* @__PURE__ */ jsx$1("svg", { width: "15", height: "14", viewBox: "0 0 15 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx$1("path", { d: "M14.4922 1.41L13.0822 0L7.49219 5.59L1.90219 0L0.492188 1.41L6.08219 7L0.492188 12.59L1.90219 14L7.49219 8.41L13.0822 14L14.4922 12.59L8.90219 7L14.4922 1.41Z", fill: "black" }) }) })
  ] });
};
const ModalBody = ({
  height,
  ...
  return /* @__PURE__ */ jsx$1("div", { css: ModalBodyStyle(height ?? 0), children });
};
const ModalFooter = ({
  buttonAlign = "left",
  children
...
const CouponInfo = ({
  ...
  const handleOnToggle = () => {
    if (!disabled) {
      onSelectionChange == null ? void 0 : onSelectionChange(!checked);
    }
  };
  ...
  return /* @__PURE__ */ jsxs(CouponInfoWrapper, { children: [
    ...
    /* @__PURE__ */ jsxs(Detail, { $disabled: disabled, children: [
      "만료일: ",
      expirationDate[0],
      "년 ",
      expirationDate[1],
    ...
    coupon.minimumAmount && /* @__PURE__ */ jsxs(Detail, { $disabled: disabled, children: [
      "최소 주문 금액: ",
      coupon.minimumAmount.toLocaleString(),
      " 원"
    ] }),
    coupon.availableTime && /* @__PURE__ */ jsxs(Detail, { $disabled: disabled, children: [
      "사용 가능 시간: ",
      formatKoreanTime(coupon.availableTime.start),
      "부터",
      " ",
      formatKoreanTime(coupon.availableTime.end),
      "까지"
    ] })
  ] });
};
const CouponInfoWrapper = /* @__PURE__ */ createStyled("div", {
  target: "e1yj6kbv3"
})({
  name: "1003mkz",
  styles: "display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;padding:16px 0;border-top:1px solid #e0e0e0;gap:8px"
});
const CouponInfoTitle = /* @__PURE__ */ createStyled("div", {
  target: "e1yj6kbv2"
})({
  name: "4d7t3c",
  styles: "display:flex;align-items:center;gap:8px;padding-bottom:8px"
});
const Title = /* @__PURE__ */ createStyled("span", {
  target: "e1yj6kbv1"
})("font-size:18px;font-weight:700;color:", ({
  $disabled
}) => $disabled ? "#bbb" : "#000000", ";");
const Detail = /* @__PURE__ */ createStyled("div", {
  target: "e1yj6kbv0"
})("font-size:14px;font-weight:400;color:", ({
  $disabled
}) => $disabled ? "#bbb" : "#000000", ";");
const CouponModal = ({
  show,
  ...
  const modalDiscount = reactExports.useMemo(() => {
    const selectedCoupons = selectedCouponIds.map((id2) => availableCoupons.find((c2) => c2.id === id2)).filter(Boolean);
  ...
  return /* @__PURE__ */ jsxs(Modal, { show, onHide, position: "center", children: [
    ...
    /* @__PURE__ */ jsxs(Modal.Body, { height: 400, children: [
      ...
      isLoading ? /* @__PURE__ */ jsx$1("p", { children: "쿠폰을 불러오는 중입니다..." }) : coupons.length > 0 ? coupons.map((coupon) => {
        const isAvailable = availableCoupons.some((av) => av.id === coupon.id);
        const checked = selectedCouponIds.includes(coupon.id);
        return /* @__PURE__ */ jsx$1(CouponInfo, { coupon, disabled: !isAvailable, checked, onSelectionChange: (isChecked) => {
          isManual.current = true;
          if (isChecked) {
            ...
            setSelectedCouponIds(selectedCouponIds.filter((id2) => id2 !== coupon.id));
          }
        } }, coupon.id);
      }) : /* @__PURE__ */ jsx$1("p", { children: "사용 가능한 쿠폰이 없습니다." })
    ] }),
    /* @__PURE__ */ jsx$1(Modal.Footer, { buttonAlign: "center", children: /* @__PURE__ */ jsxs(Modal.CancelButton, { onClick: handleApplyClick, width: "100%", children: [
      "총 ",
      modalDiscount.toLocaleString(),
      "원 할인 쿠폰 사용하기"
    ] }) })
  ] });
};
const CouponModalOpenButton = ({
  ...
  return /* @__PURE__ */ jsx$1(BaseButton, { onClick: handleClick, css: CouponModalOpenButtonStyle, children });
};
const CouponModalOpenButtonStyle = {
  name: "5a7itl",
  styles: "width:100%;height:40px;padding:8px 0;font-size:14px;font-weight:500;color:#333333bf;background-color:#ffffff;border-radius:4px;border:1px solid #33333340;cursor:pointer;&:hover{background-color:#dfdfdf40;}&:disabled{background-color:#cccccc;cursor:not-allowed;}"
};
const LabelCouponPrice = ({
  ...
  return /* @__PURE__ */ jsxs(Container$3, { children: [
    /* @__PURE__ */ jsx$1(InfoNotice, { iconSrc: `${"/react-shopping-cart/"}assets/icons/Info.svg`, children: "총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." }),
    /* @__PURE__ */ jsxs(PriceWrapper, { children: [
      /* @__PURE__ */ jsx$1(LabelPrice, { label: "주문 금액", price: orderPrice }),
      /* @__PURE__ */ jsx$1(LabelPrice, { label: "쿠폰 할인 금액", price: -totalDiscount }),
      /* @__PURE__ */ jsx$1(LabelPrice, { label: "배송비", price: actualShippingFee })
    ] }),
    /* @__PURE__ */ jsx$1(LabelPrice, { label: "총 결제 금액", price: payment })
  ] });
};
const Container$3 = /* @__PURE__ */ createStyled(Flex, {
  target: "ekrzgtz1"
})({
  name: "ry6mkg",
  styles: "flex-direction:column;gap:20px;height:180px;margin:24px 0"
});
const PriceWrapper = /* @__PURE__ */ createStyled(Flex, {
  target: "ekrzgtz0"
})({
  name: "nhmwz0",
  styles: "border-top:1px solid grey;border-bottom:1px solid grey;padding:16px 0;gap:16px"
...
function OrderItemList() {
  ...
  const isCartEmpty = !cartListData || cartListData.length === 0;
  if (!cartListData) {
    return /* @__PURE__ */ jsx$1(LoadingCartItem, { children: "장바구니를 불러오는 중..." });
  }
  const formatPrice = (price) => {
    return `${price.toLocaleString()}원`;
  };
  return /* @__PURE__ */ jsx$1(Container$2, { children: /* @__PURE__ */ jsx$1(ItemList, { children: isCartEmpty ? /* @__PURE__ */ jsxs(EmptyCartBox, { children: [
    /* @__PURE__ */ jsx$1(EmptyCartImage, { src: `${"/react-shopping-cart/"}assets/DeleteCart.svg` }),
    /* @__PURE__ */ jsx$1(EmptyCartText, { children: "주문 목록이 없습니다." })
  ] }) : selectedItems.map((order) => /* @__PURE__ */ jsx$1(ItemWithCheckboxContainer, { children: /* @__PURE__ */ jsxs(ItemContainer, { children: [
    /* @__PURE__ */ jsx$1(Image, { width: "80px", height: "80px", imageSource: order.product.imageUrl, altText: `${order.product.name} 상품 이미지` }),
    /* @__PURE__ */ jsxs(ProductInfo, { "aria-label": "상품 정보", children: [
      /* @__PURE__ */ jsx$1(ProductName, { children: order.product.name }),
      /* @__PURE__ */ jsx$1(ProductPrice, { children: formatPrice(order.product.price) }),
      /* @__PURE__ */ jsxs(ProductQuantity, { children: [
        order.quantity,
        "개"
      ] })
    ] })
...
const Container$2 = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo11"
})({
  name: "19g7nlu",
  styles: "width:100%;max-width:480px"
});
const LoadingCartItem = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo10"
})({
  name: "bflawv",
  styles: "width:100%;height:380px;display:flex;justify-content:center;align-items:center"
});
const ItemList = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo9"
})({
  name: "chf7we",
  styles: "height:260px;max-height:380px;display:flex;flex-direction:column;gap:16px;overflow-y:auto"
});
const ItemWithCheckboxContainer = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo8"
})({
  name: "sp7e3y",
  styles: "display:flex;flex-direction:column;&:last-child{border-bottom:none;}"
});
const ItemContainer = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo7"
})({
  name: "14ootmy",
  styles: "display:flex;gap:16px;padding:16px 0;border-bottom:1px solid #f0f0f0;align-items:flex-start"
});
const ProductInfo = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo6"
})({
  name: "1cywlxn",
  styles: "flex:1;display:flex;flex-direction:column;gap:8px;align-items:flex-start"
});
const ProductName = /* @__PURE__ */ createStyled("p", {
  target: "e2c2jvo5"
})({
  name: "1cl53d8",
  styles: "text-align:left;font-weight:500;font-size:12px"
});
const ProductPrice = /* @__PURE__ */ createStyled("p", {
  target: "e2c2jvo4"
})({
  name: "3k5mhv",
  styles: "font-weight:700;font-size:24px"
});
const ProductQuantity = /* @__PURE__ */ createStyled("p", {
  target: "e2c2jvo3"
})({
  name: "1nf5uxw",
  styles: "color:grey;text-align:left;font-weight:500;font-size:12px"
});
const EmptyCartBox = /* @__PURE__ */ createStyled("div", {
  target: "e2c2jvo2"
})({
  name: "w95t23",
  styles: "display:flex;flex-direction:column;justify-content:center;align-items:center;gap:16px;text-align:center;padding:32px"
});
const EmptyCartImage = /* @__PURE__ */ createStyled("img", {
  target: "e2c2jvo1"
})({
  name: "1t6d9e9",
  styles: "width:80px;height:80px;object-fit:cover;opacity:0.3"
});
const EmptyCartText = /* @__PURE__ */ createStyled("p", {
  target: "e2c2jvo0"
})({
  name: "1ldzpx6",
  styles: "width:100%;color:grey"
...
const DeliveryRegionCheckbox = ({
  ...
  return /* @__PURE__ */ jsxs(Container$1, { children: [
    /* @__PURE__ */ jsx$1(CheckBox, { isChecked: checked, onToggle, disabled }),
    /* @__PURE__ */ jsx$1(Message, { children: label })
  ] });
};
const Container$1 = /* @__PURE__ */ createStyled("div", {
  target: "e1vm4qo01"
})({
  name: "sdfbdk",
  styles: "width:100%;display:flex;justify-content:flex-start;align-items:center;gap:4px"
});
const Message = /* @__PURE__ */ createStyled("p", {
  target: "e1vm4qo00"
})({
  name: "1mg1x5f",
  styles: "font-size:12px;font-weight:500"
...
const DeliveryRegionSection = ({
  checked,
  onToggle
}) => /* @__PURE__ */ jsxs(DeliveryRegionCheckboxContainer, { children: [
  /* @__PURE__ */ jsx$1(DeliveryCheckboxTitle, { children: "배송 정보" }),
  /* @__PURE__ */ jsx$1(DeliveryRegionCheckbox, { checked, onToggle, label: "제주도 및 도서 산간 지역" })
] });
const DeliveryCheckboxTitle = /* @__PURE__ */ createStyled("h2", {
  target: "eyu86k91"
})({
  name: "165rr75",
  styles: "font-weight:700;font-size:16px"
});
const DeliveryRegionCheckboxContainer = /* @__PURE__ */ createStyled("div", {
  target: "eyu86k90"
})({
  name: "he3x5c",
  styles: "width:100%;display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;gap:8px;padding:16px 0"
});
const OrderPageInfo = ({
  typeCount,
  totalCount
}) => /* @__PURE__ */ jsxs(PageInfo, { children: [
  /* @__PURE__ */ jsx$1(InfoTitle, { children: "주문 확인" }),
  /* @__PURE__ */ jsxs(Description, { "aria-label": `총 ${typeCount}종류의 상품 ${totalCount}개를 주문합니다.`, children: [
    ...
    /* @__PURE__ */ jsx$1("p", { children: "최종 결제 금액을 확인해 주세요." })
  ] })
] });
const PageInfo = /* @__PURE__ */ createStyled("div", {
  target: "e1xudo3l2"
})({
  name: "1mbvtx",
  styles: "display:flex;justify-content:flex-start;align-items:flex-start;flex-direction:column;gap:16px"
});
const InfoTitle = /* @__PURE__ */ createStyled("h2", {
  target: "e1xudo3l1"
})({
  name: "1m6tkc",
  styles: "font-size:24px;font-weight:bold"
});
const Description = /* @__PURE__ */ createStyled("div", {
  target: "e1xudo3l0"
})({
  name: "1ufegqe",
  styles: "font-size:12px;display:flex;flex-direction:column;gap:4px;align-items:flex-start"
});
const OrderReviewPage = () => {
  ...
  const currentDiscount = reactExports.useMemo(() => {
    const selectedCoupons = selectedCouponIds.map((id2) => availableCoupons.find((c2) => c2.id === id2)).filter(Boolean);
    return selectedCoupons.reduce((total, coupon) => {
      return total + getDiscountByCouponId(coupon, orderPrice, selectedItems, isJejuOrRemoteArea);
    }, 0);
  ...
  const {
    handleBackClick,
    handleCheckout
  } = useNavigation(isDisabled, payment);
  return /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
    /* @__PURE__ */ jsx$1(Header, { left: /* @__PURE__ */ jsx$1(BackArrowButton, { onClick: handleBackClick }) }),
    /* @__PURE__ */ jsxs(Container, { children: [
      /* @__PURE__ */ jsx$1(OrderPageInfo, { typeCount, totalCount }),
      /* @__PURE__ */ jsx$1(OrderItemList, {}),
      /* @__PURE__ */ jsx$1(CouponModalOpenButton, { handleClick: handleShowCouponModal, children: "쿠폰 적용" }),
      /* @__PURE__ */ jsx$1(DeliveryRegionSection, { checked: isJejuOrRemoteArea, onToggle: handleJejuOrRemoteAreaToggle }),
      /* @__PURE__ */ jsx$1(LabelCouponPrice, { totalDiscount: currentDiscount, actualShippingFee, payment }),
      /* @__PURE__ */ jsx$1(
        CouponModal,
        {
    ...
    /* @__PURE__ */ jsx$1(CheckoutButton, { $isDisabled: isDisabled, disabled: isDisabled, onClick: handleCheckout, "aria-label": "결제하기", children: "결제하기" })
  ] });
};
const Container = /* @__PURE__ */ createStyled(Flex, {
  target: "e5o28xs1"
})({
  name: "119vkq8",
  styles: "padding:0 24px;height:calc(100vh - 116px);align-items:flex-start"
});
const CheckoutButton = /* @__PURE__ */ createStyled("button", {
  target: "e5o28xs0"
})("width:100%;padding:16px;background-color:", ({
  $isDisabled
}) => $isDisabled ? "#BDBDBD" : "#333", ";color:white;cursor:", ({
...
function App() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx$1(MobileLayout, { children: /* @__PURE__ */ jsx$1(ToastProvider, { children: /* @__PURE__ */ jsx$1(APIDataProvider, { children: /* @__PURE__ */ jsx$1(OrderListProvider, { children: /* @__PURE__ */ jsx$1(BrowserRouter, { basename: getBrowserBaseUrl(), children: /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx$1(Route, { path: "/", element: /* @__PURE__ */ jsx$1(ShoppingCartPage, {}) }),
      /* @__PURE__ */ jsx$1(Route, { path: "/order-review", element: /* @__PURE__ */ jsx$1(OrderReviewPage, {}) }),
      /* @__PURE__ */ jsx$1(Route, { path: "/order-confirm", element: /* @__PURE__ */ jsx$1(OrderConfirmPage, {}) }),
      /* @__PURE__ */ jsx$1(Route, { path: "*", element: /* @__PURE__ */ jsx$1("div", { children: /* @__PURE__ */ jsx$1("h1", { children: "Page Not Found" }) }) })
    ] }) }) }) }) }) })
  ] });
}
client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx$1(React.StrictMode, { children: /* @__PURE__ */ jsx$1(App, {}) }));
